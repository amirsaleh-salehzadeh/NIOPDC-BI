...
public class NVL {
	...
	public static String getStringContextMethod(Object obj,String methodName,String defaultValue){
		if(obj!=null){
			Object res=null;
			try {
				res = AIPUtil.invokeMultiMethod(obj, methodName);
			}catch(NoSuchMethodException e){
				e.printStackTrace();
			} catch (Exception e) {
				e.printStackTrace();
	...
	public static String getStringContextMethod(Object obj,String methodName){
		return getStringContextMethod(obj,methodName,"");
	}
