...
public class AIPErrorHandler {
	...
	synchronized public static String handle(Object obj, Exception e , String errorMessageIfExceptionIsNull , String errorMessageIfNullPointerException) {
		AIPErrorHandler errorHandler = new AIPErrorHandler();
		String error = "";
		if (e != null) {
	...
	public static void throwException(Object obj, Exception e) throws AIPException {
    	e.printStackTrace();
		String className = obj.getClass().getCanonicalName();
		className = className.substring(className.lastIndexOf(".") + 1);
		if ("MellatEPaymentWS".equalsIgnoreCase(className)) {
	    	if (e.getMessage().contains("java.net.UnknownHostException")) {
		    	throw new AIPException("ارتباط با بانک قطع شده است");
	    	} else {
	    		throw new AIPException(e.getMessage());
	    	}
		}
	}
	...
	private String recConfirmActionErrorHandle(Exception e) {
		...
		} else if (e.getMessage().contains("فقط آخرين درخواست يک مشتري براي يک فرآورده قابل ويرايش و تغيير ميباشد")) {
			error = "فقط آخرين درخواست يک مشتري براي يک فرآورده قابل ويرايش و تغيير ميباشد";
		} else if (e.getMessage().contains("درخواست تائيد شده قابل ويرايش نيست")) {
			error = "درخواست تائيد شده قابل ويرايش نيست";
		} else if (e.getMessage().contains("فقط آخرين درخواست يک مشتري براي يک فرآورده قابل تائيد ميباشد")) {
			error = "فقط آخرين درخواست يک مشتري براي يک فرآورده قابل تائيد ميباشد";
		} else if (e.getMessage().contains("فقط آخرين درخواست يک مشتري براي يک فرآورده قابل تائيد ميباشد")) {
			error = "فقط آخرين درخواست يک مشتري براي يک فرآورده قابل تائيد ميباشد";
	...
	public String orderActionErrorHandle(Exception e) {
		String error = "";
		if (e.getMessage().contains("لطفا قرارداد فروش مشتري را  وارد نمائيد")) {
			error = "لطفا قرارداد فروش مشتري را  وارد نمائيد";
		} else if (e.getMessage().contains("اشکال در اطلاعات فيش ها : فيش (ها(ي کافي براي حواله انتخاب نشده است . لطفا بررسي شود")) {
			error = "اشکال در اطلاعات فيش ها : فيش هاي کافي براي حواله انتخاب نشده است";
		} else if (e.getMessage().contains("لطفا مجوز مالي يا فيش نقدي مربوط به حواله را وارد نمائيد")) {
			error = "لطفا مجوز مالي يا فيش نقدي مربوط به حواله را وارد نمائيد";
		} else if (e.getMessage().contains("لطفا قرارداد حـمل مشتري را  وارد نمائيد")) {
			error = "لطفا قرارداد حـمل مشتري را  وارد نمائيد";
		} else if (e.getMessage().contains("اشکال در اطلاعات مجوز ها : مجوز (ها( کافي براي حواله انتخاب نشده است . لطفا بررسي شود")) {
			error = "اشکال در اطلاعات مجوز ها : مجوزهای کافي براي حواله انتخاب نشده است";
		} else if (e.getMessage().contains("مجوز انتخاب شده براي فرآورده انتخاب شده در حواله نيست و همخواني ندارد")) {
			error = "مجوز انتخاب شده براي فرآورده انتخاب شده در حواله نيست و همخواني ندارد";
		} else if (e.getMessage().contains("مانده سهمیه کمتر از مقدار حواله میباشد")) {
			error = "مانده سهمیه کمتر از مقدار حواله میباشد";
		} else if (e.getMessage().contains("اشکال در اطلاعات فيش ها : فيش (هاي مجزا( اضافي براي حواله انتخاب شده است . لطفا بررسي شود")) {
			error = "اشکال در اطلاعات فيش ها : فيش هاي اضافي براي حواله انتخاب شده است";
		} else if (e.getMessage().contains("اشکال در اطلاعات فيش ها : فيش (ها( اضافي براي حواله انتخاب شده است . لطفا بررسي شود")) {
			error = "اشکال در اطلاعات فيش ها : فيش های اضافي براي حواله انتخاب شده است";
		...
		} else if (e.getMessage().contains("اشکال در اطلاعات فيش ها : فيش  مجزا(ها(ي کافي براي حواله انتخاب نشده است . لطفا بررسي شود")) {
			error = "اشکال در اطلاعات فيش ها : فيش های مجزای کافی برای حواله انتخاب نشده است";
			...
			error = "این فیش قبلا ثبت شده است";
		} else if (e.getMessage().contains("مقدار حواله با ظرفيتهاي تعيين شده براي مشتري همخواني ندارد")) {
			error = "مقدار حواله با ظرفيتهاي تعيين شده براي مشتري همخواني ندارد";
		} else if (e.getMessage().contains("costsNotMatch")) {
			error = "عدم تطابق مبالغ هزینه ها";
		} else if (e.getMessage().contains("براي صدور حواله اينترنتي تعريف ظرفيت حمل مشتري الزامي است")) {
			error = "براي صدور حواله اينترنتي تعريف ظرفيت حمل مشتري الزامي است";
		} else if (e.getMessage().contains("شناسه سفارش درخواست شده در بانک اطلاعاتي وجود ندارد")) {
			error = "شناسه سفارش درخواست شده در بانک اطلاعاتي وجود ندارد";
		} else if (e.getMessage().contains("بسته شده است وامکان ثبت حواله جديد وجود ندارد")) {
			error = "فروش بسته شده است وامکان ثبت حواله جديد وجود ندارد";
		} else if (e.getMessage().contains("کد مشتري اشتباه است لطفا تصحيح شود")) {
			error = "کد مشتري اشتباه است لطفا تصحيح شود";
		} else if (e.getMessage().contains("غيرفعال است")) {
			int indexStart = e.getMessage().indexOf("مشتري");
			int indexEnd = e.getMessage().indexOf("غيرفعال است")+"غيرفعال است".length();
	...
	private String ordercreditActionErrorHandle(Exception e) {
		String error = "";
		if (e.getMessage().contains("از تاريخ اعتبار مجوز درخواستي گذشته است و امکان استفاده در اين حواله را ندارد")) {				
			error = "از تاريخ اعتبار مجوز درخواستي گذشته است و امکان استفاده در اين حواله را ندارد";
		} else if (e.getMessage().contains("براي اطلاعات درخواستي مجوزي پيدا نشد") )  {
			error = "براي اطلاعات درخواستي مجوزي پيدا نشد";
		} else if (e.getMessage().contains("از تاريخ اعتبار مجوز درخواستي گذشته است و امکان استفاده در اين سفارش را ندارد")) {
			error = "از تاريخ اعتبار مجوز درخواستي گذشته است و امکان استفاده در اين سفارش را ندارد";
		} else {
			error = "unhandled";
		}
		return error;
	...
	private String orderficheActionErrorHandle(Exception e) {
		...
		if (e.getMessage().contains("Violation of UNIQUE KEY constraint 'U_Fiches_FicheNo_F_CustomerID'. Cannot insert duplicate key in object 'Fiches'.")) {
			error = "این شماره فیش قبلا ثبت شده است";
			...
			error = "این فیش قبلا ثبت شده است و اطلاعات آن تکراری است";
		} else if (e.getMessage().contains("Violation of UNIQUE KEY constraint 'U_Fiches_FicheNo'")) {
			error ="این فیش قبلا ثبت شده است";
		} else if (e.getMessage().contains("محل جاري تعريف نشده است")) {
			error ="محل جاري تعريف نشده است";
		} else if (e.getMessage().contains("محل جاري در منوي  کاربر تعريف نشده است")) {
			error ="محل جاري در منوي  کاربر تعريف نشده است";
		} else if (e.getMessage().contains("غيرفعال است")) {
	...
	public String orderPursuitActionErrorHandle(Exception e) {
		...
		} else if (e.getMessage().contains("سفارش مورد درخواست وجود ندارد")) {
			error = "حواله مورد درخواست وجود ندارد";
		} else if (e.getMessage().contains("کد مشتري اشتباه است")) {
			error = "کد مشتري اشتباه است";
		} else if (e.getMessage().contains("سفارش درخواست شده به شماره")) {
			error = e.getMessage().split("--->")[1];
		} else {
			error = "unhandled";
		}
	...
	synchronized public static String getMellatMessage(Integer msgCode , int mode) {
		...
		case 2:
			switch (msgCode) {
			case -2:
				message = "اشکال در برقراری ارتباط با بانک (timeout). لطفا مجددا سعی کنید";
				break;
			case -1:
				message = "با توجه به فیش های استفاده شده برای این حواله نیازی به پرداخت الکترونیکی نیست";
				break;
			case 0:
			...
			case 14:
				...
				break;
			case 30:
				message = "فرمت پیام دارای اشکال می باشد";
				break;
			case 33:
				message = "تاریخ استفاده از کارت به پایان رسیده است";
				break;
			case 38:
				message = "ورود شماره شناسایی از حد مجاز به پایان رسیده است";
				break;
			case 41:
				message = "کارت مفقود می باشد";
				break;
			case 43:
			...
			case 55:
				...
				break;
			case 57:
				message = "دارنده کارت مجاز به استفاده از این کارت نمی باشد";
				break;
			case 58:
				message = "پذیرنده کارت مجاز به استفاده از این کارت نمی باشد";
				break;
			case 61:
				message = "مبلغ تراکنش از حد مجاز بالاتر است";
				break;
			case 65:
				message = "تعداد دفعات تراکنش از حد مجاز بیشتر است";
				break;
			case 76:
				message = "شماره کارت در سیستم موجود نمی باشد";
				break;
			case 80:
				message = "تراکنش موفق عمل نکرده است";
				break;
			case 84:
				message = "سویچ صادر کننده فعال نیست";
				break;
			case 88:
				message = "سیستم بانک دچار اشکال شده است";
				break;
			case 90:
				message = "سیستم صدور مجوز انجام تراکنش موقتا غیر فعال است و یا زمان تعیین شده برای مجوز به پایان رسیده است";
				break;
			case 93:
				message = "عدم انطباق در شماره شناسایی فایل پیکربندی";
				break;
			case 94:
				message = "کد رزرو تکراری است";
				break;
			case 95:
				message = "ترمینال غیر فعال است";
				break;
			case 96:
			...
			case 98:
				...
				break;
			case 101:
				message = "ارسال فایل های مورد نیاز";
				break;
			case 102:
				message = "شماره پیگیری صحیح نمی باشد";
				break;
			case 103:
				message = "برای این hash code تراکنشی صورت نگرفته است";
				break;
			case 110:
		...
		case 8:
			switch(msgCode) {
			case -1:
				message = "اشکال در برقراری ارتباط با بانک لطفا مجددا سعی کنید";
				break;
			case 0:
				message = "تراکنش با موفقیت انجام شد";
				break;
			case 1:
				...
				break;
			case 2:
				message = "رکوردی از طرف بانک پیدا نشد";
				break;
			case 3:
			...
			case 7:
				...
				break;
			case 8:
				message = "تراکنش پیش از این اعلام موفقیت شده است";
				break;
			case 9:
				message = "تراکنش نامعتبر";
				break;
		...
		case 7:
			switch(msgCode) {
			case 0:
				message = "موفقيت آميز بودن انجام درخواست";
				break;
			case 2:
			...
			case 12:
				...
				break;
			case 13:
				message = "سرويس براي اين مشتري غيرفعال مي باشد";
				break;
			case 21:
	...
	synchronized public static String getMelliMessage(Integer msgCode) {
		...
		case -2:
			...
			break;
		case -1:
			message = "خطای برگشتی از سایت بانک ملی: یکی از موارد مبلغ، شماره سفارش یا کلید اشتباه است";
			break;
		case 0:
			message = "تراکنش با موفقیت به انجام رسید";
			break;
		case 1:
			message = "با بانک صادر کننده تماس حاصل نمایید";
			break;
		case 3:
			message = "پذیرنده کارت فعال نیست";
			break;
		case 12:
		...
		case 13:
			...
			break;
		case 33:
			message = "تاریخ استفاده کارت به پایان رسیده است";
			break;
		case 41:
			message = "کارت مفقوده می باشد";
			break;
		case 43:
		...
		case 80:
			...
			break;
		case 84:
			message = "سوئیچ صادر کننده کارت فعال نیست";
			break;
		case 88:
		...
		case 1019:
			...
			break;
		case 9005:
			message = "تراکنش ناموفق ( مبلغ به حساب دارنده کارت برگشت داده شده است)";
			break;
		case 9006:
	...
	synchronized public static String getSamanMessage(double msgCodeDBL) {
		...
		case -3:
			...
			break;
		case -4:
			message = "Merchant Authentication Failed ( کلمه عبور يا کد فروشنده اشتباه است)";
			break;
		case -5:
			message = "Database Exception";
			break;
		case -6:
			message = "سند قبلا برگشت کامل يافته است";
			break;
		case -7:
		...
		case -16:
			...
			break;
		case -17:
			message = "برگشت زدن جزيي تراکنشي که با کارت بانکي غير از بانک سامان انجام پذيرفته است";
			break;
		case -18:
			message = "IP Address  فروشنده نا معتبر است";
			break;
		case 1:
		...
		case 6:
			...
			break;
		case 7:
			message = "رمز کارت (PIN) 3 مرتبه اشتباه وارد شده است در نتيجه کارت غير فعال خواهد شد.";
			break;
		case 8:
			message = "خريدار رمز کارت (PIN) را اشتباه وارد کرده است.";
			break;
		case 9:
			message = "مبلغ بيش از سقف برداشت مي باشد.";
			break;
		case 10:
		...
		case 11:
			...
			break;
		case 12:
			message = "خريدار يا فيلد CVV2 و يا فيلد ExpDate را اشتباه زده است. ( يا اصلا وارد نکرده است)";
			break;
		case 13:
			message = "موجودي به اندازي کافي در حساب وجود ندارد.";
			break;
		case 14:
