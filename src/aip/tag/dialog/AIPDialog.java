...
//	String img=baseFolder+"/dialog/window_dialog.gif";
	...
	String toolbar="<input type='button' value='تایید' id='confirmButtonDialog' onclick='closeDialog(\"dialog1\");[ONOKCLICKPLACEHOLDER]'/><input type='button' id='returnButtonDialog' value='انصراف' onclick='closeDialog(\"dialog1\");'/>";
	String toolbarExtra="";
	String onOKClick="";
