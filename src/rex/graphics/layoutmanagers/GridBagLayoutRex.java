...
class GridBagLayoutInfo implements java.io.Serializable {
  ...
  GridBagLayoutInfo () {
    minWidth = new int[GridBagLayoutRex.MAXGRIDSIZE];
    minHeight = new int[GridBagLayoutRex.MAXGRIDSIZE];
    weightX = new double[GridBagLayoutRex.MAXGRIDSIZE];
    weightY = new double[GridBagLayoutRex.MAXGRIDSIZE];
  }
}
 ...
 * @since JDK1.0
 */
public class GridBagLayoutRex implements LayoutManager2,
     ...
     */
  protected static final int MAXGRIDSIZE = 512 * 50;
