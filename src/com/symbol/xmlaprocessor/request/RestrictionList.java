	...
	extends Request
{
	...
	public static final String LOCAL_NAME = "RestrictionList";
	...
	public RestrictionList(String _name, Restriction[] _restriction) 
		throws SOAPException
	{
		super(LOCAL_NAME, (Request[])_restriction);
	}
}
