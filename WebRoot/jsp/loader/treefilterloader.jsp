...
<head>
	...
	$(document).ready(function () {
		$("#selectedIds").val($("#txtFiltersID").val());
		$("#selectedNames").val($("#txtFilters").val());
		checkSelectedIds('treFilterMembersLoader');
	});
...
<aip:tree id="treFilterMembersLoader" loader="<%="/memberswithcheck.do?reqCode=hierarchy&id="+id +"&nodeType=CheckBox"%>" 
		  title=""
