...
<xsl:template match="tool-button">
  <td>
    <input type="image" name="{@id}" src="{$context}/{$imgpath}/{@img}.png" border="0" title="{@title}" width="32" height="32"/>
  </td>
</xsl:template>
...
<xsl:template match="img-button">
  <td>
    <a href="{@href}">
      ...
      <img src="{$context}/{$imgpath}/{@img}.png" border="0" title="{@title}" width="32" height="32"/>
    </a>
  </td>
</xsl:template>
